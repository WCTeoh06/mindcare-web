...
## 🚀 Live Demo
**[Click here to view the Live Project on Vercel](https://wcteoh06.github.io/mindcare-web/)** *(Note: You will need a Gemini API Key and Firebase Config to enter the app. See Setup below.)*
